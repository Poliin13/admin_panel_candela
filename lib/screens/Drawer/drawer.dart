...
class SideDrawer extends StatelessWidget {
    ...
    return Drawer(
      child: ListView(
        children: [
          ...
          _buildExpansionTile(context, Icons.science, "physics_1st_paper",
  ...
  List<Widget> physicsMathChapters(BuildContext context) => [
        buildListTile(context, Icons.rocket, "physics_1st_paper", 'Chapter 1',
            'chapter_1_math', Colors.lightBlue[800]!),
        buildListTile(context, Icons.rocket, "physics_1st_paper", 'Chapter 2',
            'chapter_2_math', Colors.lightBlue[900]!),
        buildListTile(context, Icons.rocket, "physics_1st_paper", 'Chapter 3',
            'chapter_3_math', Colors.lightBlue[800]!),
        buildListTile(context, Icons.rocket, "physics_1st_paper", 'Chapter 4',
            'chapter_4_math', Colors.lightBlue[900]!),
        buildListTile(context, Icons.rocket, "physics_1st_paper", 'Chapter 5',
            'chapter_5_math', Colors.lightBlue[800]!),
        buildListTile(context, Icons.rocket, "physics_1st_paper", 'Chapter 6',
            'chapter_6_math', Colors.lightBlue[900]!),
        buildListTile(context, Icons.rocket, "physics_1st_paper", 'Chapter 7',
            'chapter_7_math', Colors.lightBlue[800]!),
        buildListTile(context, Icons.rocket, "physics_1st_paper", 'Chapter 8',
            'chapter_8_math', Colors.lightBlue[900]!),
        buildListTile(context, Icons.rocket, "physics_1st_paper", 'Chapter 9',
            'chapter_9_math', Colors.lightBlue[800]!),
        buildListTile(context, Icons.rocket, "physics_1st_paper", 'Chapter 10',
            'chapter_10_math', Colors.lightBlue[900]!),
      ];

  List<Widget> physicsMath2ndChapters(BuildContext context) => [
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 1',
            'chapter_1_math_2nd', Colors.teal[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 2',
            'chapter_2_math_2nd', Colors.teal[900]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 3',
            'chapter_3_math_2nd', Colors.teal[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 4',
            'chapter_4_math_2nd', Colors.teal[900]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 5',
            'chapter_5_math_2nd', Colors.teal[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 6',
            'chapter_6_math_2nd', Colors.teal[900]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 7',
            'chapter_7_math_2nd', Colors.teal[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 8',
            'chapter_8_math_2nd', Colors.teal[900]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 9',
            'chapter_9_math_2nd', Colors.teal[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 10',
            'chapter_10_math_2nd', Colors.teal[900]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 11',
            'chapter_11_math_2nd', Colors.teal[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Math-2nd', 'Chapter 12',
            'chapter_12_math_2nd', Colors.teal[900]!),
      ];

  List<Widget> physicsObjectivesChapters(BuildContext context) => [
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 1',
            'chapter_1_physics_objectives', Colors.green[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 2',
            'chapter_2_physics_objectives', Colors.green[900]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 3',
            'chapter_3_physics_objectives', Colors.green[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 4',
            'chapter_4_physics_objectives', Colors.green[900]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 5',
            'chapter_5_physics_objectives', Colors.green[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 6',
            'chapter_6_physics_objectives', Colors.green[900]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 7',
            'chapter_7_physics_objectives', Colors.green[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 8',
            'chapter_8_physics_objectives', Colors.green[900]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 9',
            'chapter_9_physics_objectives', Colors.green[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 10',
            'chapter_10_physics_objectives', Colors.green[900]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 11',
            'chapter_11_physics_objectives', Colors.green[800]!),
        buildListTile(context, Icons.rocket, 'Physics-Objectives', 'Chapter 12',
            'chapter_12_physics_objectives', Colors.green[900]!),
      ];
